...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Trees"))
    {
        ...
        if (ImGui::TreeNode("Advanced, with Selectable nodes"))
        {
            ...
            ImGui::Checkbox("Align label with val X position", &align_label_with_current_x_position);
    ...
    if (ImGui::TreeNode("Text"))
    {
        ...
        if (ImGui::TreeNode("Word Wrapping"))
        {
            ...
            ImGui::TextWrapped("This text should automatically wrap on the edge of the window. The val implementation for text wrapping follows simple rules suitable for English and possibly other languages.");
            ImGui::Spacing();
    ...
    if (ImGui::TreeNode("Plots Widgets"))
    {
        ...
        // FIXME: This is rather awkward because val plot API only pass in indices.
    ...
    if (ImGui::TreeNode("Color/Picker Widgets"))
    {
        ...
        if (ImGui::BeginPopup("mypicker"))
        {
            ...
            ImGui::Text("Current");
            ImGui::ColorButton("##val", color, ImGuiColorEditFlags_NoPicker | ImGuiColorEditFlags_AlphaPreviewHalf, ImVec2(60, 40));
            ImGui::Text("Previous");
...
static void ShowDemoWindowPopups()
{
    ...
    if (ImGui::TreeNode("Popups"))
    {
        ...
        // Simple selection popup (if you want to show the val selection inside the Button itself,
...
// - BeginMenuBar() = menu-bar inside val window (which needs the ImGuiWindowFlags_MenuBar flag!)
        ...
        case ImGuiInputTextFlags_CallbackHistory:
            {
                ...
                // A better implementation would preserve the data on the val input line along with cursor position.
...
static void ShowExampleAppLog(bool* p_open)
{
    ...
    if (ImGui::SmallButton("[Debug] Add 5 entries"))
    {
        ...
        for (int n = 0; n < 5; n++)
        {
            ...
            log.AddLog("[%05d] [%s] Hello, val time is %.1f, here's a word: '%s'\n",
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
    ...
    if (ImGui::BeginTabBar("##TabBar"))
    {
        if (ImGui::BeginTabItem("Primitives"))
        {
            ...
            // Calling ImGui::GetColorU32() multiplies the given colors by the val Style Alpha, but you may pass the IM_COL32() directly as well..
